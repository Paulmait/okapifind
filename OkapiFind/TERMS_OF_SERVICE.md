...
By downloading, installing, or using OkapiFind ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

## 2. Description of Service

OkapiFind is a mobile application that helps users save and find their parking locations. The App provides location saving, navigation assistance, and parking management features.

## 3. User Accounts

- You may use the App without creating an account (Guest Mode) or by signing in with Google or Apple.
...
- Location accuracy may vary based on device, environment, and GPS signal strength.
- The App should not be used as the sole means of navigation.

## 6. Subscriptions and Payments

- Some features require a paid subscription (OkapiFind Plus or Pro).
- Subscriptions are billed through Apple App Store or Google Play Store.
- Subscriptions automatically renew unless cancelled at least 24 hours before the end of the current period.
- Refunds are handled according to Apple/Google's refund policies.
...
- That parking information or alerts will be accurate

## 8. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW:
- We are not liable for any indirect, incidental, special, or consequential damages
- We are not liable for parking tickets, towing, or any parking-related incidents
- Our total liability shall not exceed the amount you paid for the App in the past 12 months

## 9. Indemnification

You agree to indemnify and hold harmless CIEN RIOS, LLC and its officers, directors, employees, and agents from any claims, damages, or expenses arising from your use of the App or violation of these Terms.

## 10. Intellectual Property

- The App and its content are owned by CIEN RIOS, LLC.
