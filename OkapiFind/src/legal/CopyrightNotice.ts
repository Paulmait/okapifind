 ...
 * Required for open source compliance and legal protection
 */
...
SOFTWARE COPYRIGHT
The OkapiFind application source code, algorithms, and implementation are proprietary and confidential information belonging to OkapiFind.

THIRD-PARTY ATTRIBUTIONS

This software incorporates open source and third-party components:
...
Licensed under the MIT License
https://github.com/RevenueCat/react-native-purchases/blob/main/LICENSE

Sentry
Copyright (c) 2019 Sentry
Licensed under the MIT License
https://github.com/getsentry/sentry-react-native/blob/main/LICENSE
...
System Fonts are used under their respective licenses:
- San Francisco (iOS): © Apple Inc.
- Roboto (Android): © Google Inc.

SOUND EFFECTS AND AUDIO

Notification sounds are either original or licensed under Creative Commons:
- CC0 1.0 Universal (Public Domain)
- CC BY 3.0

IMAGE ASSETS

All original image assets, including but not limited to:
- App icon
- Splash screen
- UI elements
- Marketing materials
...
OkapiFind® and the OkapiFind logo are registered trademarks of OkapiFind.

Other trademarks mentioned in this application:
- Apple, iOS, iPhone, iPad are trademarks of Apple Inc.
- Google, Android, Google Play are trademarks of Google LLC
...
- COPPA (Children's Online Privacy Protection Act) - App is not directed at children under 13

REPORTING COPYRIGHT INFRINGEMENT

If you believe that any content in this application infringes your copyright, please contact:

Copyright Agent
OkapiFind Legal Department
Email: copyright@okapifind.com
